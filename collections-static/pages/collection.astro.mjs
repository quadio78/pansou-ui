...
</button> <button class="text-white bg-green-500 hover:bg-green-600 px-4 py-2 rounded-lg flex items-center transition-colors duration-200 open-link-btn"${addAttribute(resource.link, "data-link")}> <i class="fas fa-external-link-alt mr-2"></i>立即查看
</button> ${resource.password && renderTemplate`<button class="text-white bg-purple-500 hover:bg-purple-600 px-4 py-2 rounded-lg flex items-center transition-colors duration-200 copy-password-btn"${addAttribute(resource.password, "data-password")}> <i class="fas fa-key mr-2"></i>复制密码
